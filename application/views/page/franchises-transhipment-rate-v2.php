<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Franchise Transhipment Rate</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Franchise</a></li> 
    <li class="active">Franchise Transhipment Rate</li>
  </ol>
</section>
<!-- Main content -->
<section class="content"> 
    <div class="box box-success">
        <div class="box-body">   
             <form method="post" action="<?php echo site_url('franchise-transhipment-rate-v2');?>">
             <div class="row">  
  ...
  <div class="box box-info">
               ...
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center">
                        <button data-toggle="modal" data-target="#edit_modal" data="<?php echo $info['c_type']?>"   value="<?php echo $info['franchises_ts_rate_id']?>" class="edit_record btn btn-primary" title="Edit"><i class="fa fa-edit"></i></button>
                    </td>                                  
   ...
   <form method="post" action="<?php echo site_url('franchise-transhipment-rate-v2');?>">
    <div class="box box-success">
        <div class="box-header with-border "><h4>Copy Franchise Transhipment Rate</h4></div>
        <div class="box-body">
            <div class="row">
                <div class="form-group col-md-4">
                    <label>From </label> 
                    <?php echo form_dropdown('from_franchise_id',array('' => 'Select the Franchise')  + $franchise_opt  ,set_value('from_franchise_id',$srch_franchise_id) ,' id="from_franchise_id" class="form-control" readonly="true" required');?> 
                </div>
                <div class="form-group col-md-4">
                    <label>To</label> 
                    <?php echo form_dropdown('to_franchise_id',array('' => 'Select the Franchise')  + $franchise_opt  ,set_value('to_franchise_id') ,' id="to_franchise_id" class="form-control" required');?> 
                </div>
                <div class="form-group col-md-4"> 
                     <br />
                     <button type="submit" name="btn_copy" value="Copy Rates" class="btn btn-info"><span class="fa fa-copy"></span> Copy Rates</button>
                 </div>
            </div>
        </div>
    </div>    
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title" id="scrollmodalLabel">Add : Franchise Transhipment Rate</h3>
                    ...
                    <div class="modal-body"> 
                        <div class="row"> 
                             ...
                             <div class="form-group col-md-4">
                                ...
                                <?php echo form_dropdown('service_id',array('' => 'Select Mode')  + $service_opt  ,set_value('service_id') ,' id="service_id" class="form-control" required= "true"');?>
                             </div>
                             <div class="form-group col-md-4">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <input type="hidden" name="franchises_ts_rate_id" id="franchises_ts_rate_id" />
                    ...
                    <div class="modal-body"> 
                        <div class="row"> 
                             <div class="form-group col-md-8">
                                <label>Franchise</label>
                                <?php echo form_dropdown('franchise_id',array('' => 'Select the Franchise')  + $franchise_opt  ,set_value('franchise_id') ,' id="franchise_id" class="form-control" required');?>
                             </div>
                             <div class="form-group col-md-4">
                                <label>Transit Mode</label>
                                <?php echo form_dropdown('service_id',array('' => 'Select Mode')  + $service_opt  ,set_value('service_id') ,' id="service_id" class="form-control" required= "true"');?>
