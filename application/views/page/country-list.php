          ...
          <tbody>
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center">
                        <button value="<?php echo $ls['country_id']?>" class="del_record btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button>
                    </td>                                      
                </tr>
                <?php
                    }
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollmodalLabel">Add Country</h5>
