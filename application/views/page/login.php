...
<head>
  ...
  <title>Elbex Admin Panel Login</title>
...
<div class="login-box">
  ...
  <div class="login-box-body" style="border-radius: 20px;">
    <div class="login-logo bg-yellow-gradient">
        <center><a href=""><img src="<?php echo base_url() ?>asset/images/logo.png" class="img-responsive img-rounded" /></a></center>
        
    </div>
    
    <p class="login-box-msg">
    <i class="fa fa-user-circle-o fa-4x bg-yellow-gradient img-rounded pad"></i> <br /> Sign in to start your session
    <?php  
    if($login === false) 
